...
export default function Login() {
	...
	async function handleGoogleLogin() {
		await handleFirebaseSocialLogin(googleProvider, "Google");
	}

	async function handleFacebookLogin() {
		await handleFirebaseSocialLogin(facebookProvider, "Facebook");
	}
					...
					<div style={css.leftInner}>
						...
						<div style={css.leftContent}>
							...
							<p style={css.leftSubtext}>
								Sign in to manage your campus resources, track maintenance
								requests, and stay connected with your community.
							</p>
					...
					<div style={css.formCard}>
						...
						<form onSubmit={handleLogin} noValidate>
							...
							<div style={css.fieldGroup}>
								...
								{errors.password && (
									<p style={css.errText}>{errors.password}</p>
								)}
							</div>
