...
/* ── helpers ──────────────────────────────────────────────────────────────── */
const ROLE_COLORS = {
    ROLE_USER:       { label: "Student",       bg: "#eff6ff", color: "#1d4ed8", dot: "#3b82f6" },
    ROLE_TECHNICIAN: { label: "Technician",    bg: "#f0fdf4", color: "#15803d", dot: "#22c55e" },
    ROLE_MANAGER:    { label: "Manager",       bg: "#fdf4ff", color: "#7e22ce", dot: "#a855f7" },
    ROLE_ADMIN:      { label: "Administrator", bg: "#fef3c7", color: "#92400e", dot: "#f59e0b" },
};
...
function NotifIcon({ type }) {
    ...
    switch (type) {
        case "WELCOME":
            return <div style={{ ...s, background: "#eff6ff" }}><FiGift size={13} color="#3b82f6" /></div>;
        case "BOOKING":
            return <div style={{ ...s, background: "#f0fdf4" }}><FiCalendar size={13} color="#16a34a" /></div>;
        case "TICKET":
            return <div style={{ ...s, background: "#fdf4ff" }}><FiAlertCircle size={13} color="#9333ea" /></div>;
        case "RESOURCE":
            return <div style={{ ...s, background: "#fff7ed" }}><FiBookOpen size={13} color="#ea580c" /></div>;
        case "SYSTEM":
            return <div style={{ ...s, background: "#fef3c7" }}><FiZap size={13} color="#d97706" /></div>;
        default:
            return <div style={{ ...s, background: "#f1f5f9" }}><FiInfo size={13} color="#64748b" /></div>;
    }
}
...
export default function UserDashboard() {
    ...
    async function handleAddUser(role) {
        ...
        try {
            ...
            fetchStats();
            closeAddModals();
            showToast(`${role === "ROLE_ADMIN" ? "Admin" : "Technician"} account created`);
        } catch (err) {
                ...
                <div style={{ ...S.modal, maxWidth: 460 }} onClick={(e) => e.stopPropagation()}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
                        <div>
                            ...
                            <input
                                style={{ ...S.modalInput, ...(newUserErrors.fullName ? { borderColor: "#f87171" } : {}) }}
                            ...
                            {newUserErrors.fullName && (
                                <p style={{ fontSize: 12, color: "#dc2626", marginTop: 3 }}>{newUserErrors.fullName}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {newUserErrors.email && (
                                <p style={{ fontSize: 12, color: "#dc2626", marginTop: 3 }}>{newUserErrors.email}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {newUserErrors.password && (
                                <p style={{ fontSize: 12, color: "#dc2626", marginTop: 3 }}>{newUserErrors.password}</p>
                            )}
                        </div>
                    </div>
    ...
    return (
        <div style={S.page}>
            <aside style={S.sidebar}>
                <div style={S.sidebarTop}>
                    ...
                    <nav style={{ marginTop: "2rem" }}>
                        ...
                        <Link to="/dashboard" style={{ ...S.navItem, textDecoration: "none", display: "flex", gap: 10 }}>
                            <FiHome size={15} />
                            <span>Main App</span>
                        </Link>
            ...
            <main style={S.main}>
                <header style={S.header}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <button onClick={() => openAddModal("ROLE_ADMIN")} style={{ ...S.actionHeaderBtn, background: "#92400e" }}>
                            <FiUserPlus size={14} /> Add Admin
                        </button>

                        <button onClick={() => openAddModal("ROLE_TECHNICIAN")} style={{ ...S.actionHeaderBtn, background: "#15803d" }}>
                                        ...
                                        {notifLoad ? (
                                            ...
                                            notifs.map((n) => (
                                                ...
                                                >
                                                    ...
                                                    <div style={{ flex: 1 }}>
                                                        <p style={{ fontSize: 12, fontWeight: n.read ? 500 : 700, color: "#0f172a", marginBottom: 2 }}>
                                                            {n.title}
                                                        </p>
                    ...
                    <>
                        <div style={S.filterBar}>
                            ...
                            <div style={S.roleFilters}>
                                {["ALL", "ROLE_USER", "ROLE_TECHNICIAN", "ROLE_MANAGER", "ROLE_ADMIN"].map((r) => (
                                    <button
                                        key={r}
                                ...
                                <table style={S.table}>
                                    ...
                                    <tbody>
                                        {filtered.map((user, i) => {
                                            ...
                                            return (
                                                <tr key={userKey} style={{ ...S.tr, background: i % 2 === 0 ? "#fff" : "#f8fafc" }}>
                                                    <td style={S.td}>
                                                    ...
                                                    <td style={S.td}>
                                                        <div style={{ display: "flex", gap: 5 }}>
                                                            <button onClick={() => openEdit(user)} style={S.actionBtn} title="Edit">
                                                                <FiEdit2 size={13} />
                                                            </button>
                                                            ...
                                                            <button
                                                                onClick={() => {
                                                                    setSendForm((f) => ({ ...f, userId: userKey }));
                                                                    setSendPanel(true);
            ...
            <AddUserModal role="ROLE_ADMIN" open={addAdminOpen} onClose={closeAddModals} />
            <AddUserModal role="ROLE_TECHNICIAN" open={addTechOpen} onClose={closeAddModals} />
                ...
                <div style={S.overlay} onClick={() => setSendPanel(false)}>
                    <div style={{ ...S.modal, maxWidth: 480 }} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={{ display: "flex", gap: 8, marginBottom: "1rem" }}>
                            <button onClick={() => setBroadcastMode(false)} style={{ ...S.toggleBtn, ...(!broadcastMode ? S.toggleBtnActive : {}) }}>
                                Single User
                            </button>
                            <button onClick={() => setBroadcastMode(true)} style={{ ...S.toggleBtn, ...(broadcastMode ? S.toggleBtnActive : {}) }}>
                                Broadcast to All
                            </button>
                        </div>
                        ...
                        <div style={{ display: "flex", gap: 10, marginTop: "1.5rem", justifyContent: "flex-end" }}>
                            ...
                            <button onClick={handleSendNotification} disabled={sendLoading} style={{ ...S.modalSaveBtn, display: "flex", alignItems: "center", gap: 6 }}>
                                <FiSend size={13} />
                    ...
                    <div style={S.modal} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginTop: "1.25rem" }}>
                            ...
                            <div>
                                ...
                                >
                                    {["ROLE_USER", "ROLE_TECHNICIAN", "ROLE_MANAGER", "ROLE_ADMIN"].map((r) => (
                ...
                <div style={S.overlay} onClick={() => setDeleteTarget(null)}>
                    <div style={{ ...S.modal, maxWidth: 380 }} onClick={(e) => e.stopPropagation()}>
                        ...
                        <p style={{ fontSize: 14, color: "#64748b", margin: "8px 0 20px", textAlign: "center" }}>
                            This will permanently delete <strong>{deleteTarget.fullName || deleteTarget.email}</strong>.
                        </p>
